...
# All code contained within this file is for locating someone's office within HST
# Please do not move HST name locating code out of this file (aside from importing and adding the intent handler in lambda_function.py)
...
# Levenshtein distance for better name recognition
...
class HSTStaffLocatorIntentHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("HSTStaffLocatorIntent")(handler_input)
